...
CREATE PROCEDURE [dbo].[uspPULSEApiGetDailyActivityDetailsForCohort]
...
Execute Sample	: 
	...
	EXEC dbo.uspPULSEApiGetDailyActivityDetailsForCohort
		@pSourceSystemID			= 2
		, @pInstitutionID			= 9
...
**********************************************************************************************************************************/
	...
	SELECT 
		@UniqueAssessments = COUNT(DISTINCT AssessmentName)
	FROM
