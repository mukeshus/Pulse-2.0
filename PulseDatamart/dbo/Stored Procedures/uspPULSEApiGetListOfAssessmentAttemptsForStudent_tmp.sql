...
CREATE PROCEDURE [dbo].[uspPULSEApiGetListOfAssessmentAttemptsForStudent_tmp]
...
Execute Sample	: 
	...
	EXEC dbo.uspPULSEApiGetListOfAssessmentAttemptsForStudent_tmp
		@pSourceSystemID			= 2
...
**********************************************************************************************************************************/
	...
	IF @PrimarySortOrder = 'DESC'
		SELECT
			CONVERT(DATE,LatestAssessmentDateTime) AS AssessmentDate
			, AssessmentID
			, AssessmentName
			, TotalScore
			, RiskCategory
...
===================================================================================================================================
|   Deepak Patro     | 22-Oct-2018 | ATIPUL2-1230 - Updated logic as per changes in requirement                                  |
===================================================================================================================================
**********************************************************************************************************************************/
